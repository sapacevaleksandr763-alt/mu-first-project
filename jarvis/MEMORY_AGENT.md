...
- **Имя:** Александр
- **Роль:** Фрилансер-дизайнер
- **Чем занимаюсь:** Фрилансер в сфере дизайна и креатива. Развивает собственный дизайн-сервис.
...
- **Код:** HTML/CSS/JS
- **AI:** Claude Code (VS Code + VPS)
- **Бот:** Telegram-бот (Node.js)
...
- **Обращение:** ты
- **Стиль ответов:** Средне — ответ + краткое пояснение в 2-3 предложения. Если задача простая — можно коротко.
